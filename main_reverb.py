...
import yaml
from data_utils_rawboost import genSpoof_list,Dataset_ASVspoof2019_train,Dataset_ASVspoof2021_eval, Dataset_ASVspoof2019_reverb
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rirscp', type=str, default='rir.scp', help='RIR SCP')
    parser.add_argument('--probability', type=float, default=0.0)
    parser.add_argument('--name_tag', type=str, default='', help='Model name tag')
    '''
    % database_path/
    ...
    model_tag = 'model_{}_{}_{}_{}_{}{}'.format(
        track, args.loss, args.num_epochs, args.batch_size, args.lr, args.name_tag)
    if args.comment:
    ...
    train_set=Dataset_ASVspoof2019_reverb(args,list_IDs = file_train,
              labels = d_label_trn,
              base_dir =os.path.join(args.database_path+'ASVspoof2019_{}_train/'.format(args.track)),algo=args.algo,
              rirscp = args.rirscp, probability = args.probability)
    ...
    for epoch in range(num_epochs):
        ...
        print('\nTRAIN: Epoch {} - {} - {:.2f} - {:.2f}'.format(epoch,
